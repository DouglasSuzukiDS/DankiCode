...
# Utilizando funces principais dos sets
'''conjunto1 = {1, 5, 8, 9}
conjunto2 = {3, 6, 2}

conjunto3 = conjunto1.union(conjunto2)  # União dos conjuntos
print(conjunto3)'''

conjunto1 = {1, 5, 3, 2}
conjunto2 = {3, 6, 2}

# conjunto3 = conjunto1.intersection(conjunto2)  # Interseção dos conjuntos
# print(conjunto3)  # Elementos que estão em ambos os conjuntos

# conjunto3 = conjunto1.symmetric_difference(conjunto2)  # Diferença simétrica dos conjuntos
# print(conjunto3)  # Elementos que estão em um dos conjuntos, mas não em ambos
